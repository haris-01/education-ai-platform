export interface QuestionComment {
  ...
  // The sentences within `comment` that describe a candidate error,
  // verbatim. Empty when the examiner described no mistake for this
  // question, or described one without any of the marker phrases
  // `extractCommonMistakes` looks for.
